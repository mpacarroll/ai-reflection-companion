...
(templates/CLAUDE.md.tpl and repos/ai-reflection-companion/PROFILE.md) and re-run the script.
...
- Repo profile: [repos/ai-reflection-companion/PROFILE.md](https://github.com/mpacarroll/ai-instructions/blob/main/repos/ai-reflection-companion/PROFILE.md)
